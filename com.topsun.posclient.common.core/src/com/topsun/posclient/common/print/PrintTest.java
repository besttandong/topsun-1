...
public class PrintTest implements Printable {
    ...
    public static void  printReport() {
        ...
        pf.setOrientation(PageFormat.PORTRAIT);  //设置打印方向，LANDSCAPE为横向，打印方向默认为纵向
        pf.setPaper(paper);
        
        PrintTest  printTest=new PrintTest();
        printTest.setValue(new String []{"testddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd", "testsss", "testssss"});
